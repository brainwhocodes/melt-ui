...
>
	<Settings2 class="surface-a38d397ce6" />
	<span class="surface-d65833c84f">Open Popover</span>
</button>

{#if $open}
	<div {...$overlay} use:overlay class="surface-502278e58a"></div>
	<div
		{...$content} use:content
