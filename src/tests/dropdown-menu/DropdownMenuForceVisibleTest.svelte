...
<main>
	...
	{#if $open}
		<div class="menu" {...$menu} use:menu data-testid="menu" transition:slide>
			...
			{#if $subOpen}
				<div class="menu subMenu" {...$subMenuA} use:subMenuA data-testid="submenu" transition:slide>
					<div class="text">People</div>
					<div {...$radioGroup} use:radioGroup>
						{#each personsArr as person, i}
							<div
								class="item"
								{...$radioItem({ value: person })} use:radioItem
				...
				<div {...$separator} use:separator class="separator"></div>
				<div class="item" {...$item} use:item data-testid="item3">
					Quit Melt UI
