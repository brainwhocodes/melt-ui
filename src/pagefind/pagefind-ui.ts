(() => {
	...
	var A = (n, e) => {
		for (var t in e) Gn(n, t, { get: e[t], enumerable: !0 });
	};
	function j() {}
	function Qe(n) {
		return n();
	...
	function se(n, e) {
		return (
			Le || (Le = document.createElement('a')), (Le.href = e), n === Le.href
		);
	}
	function zt(n) {
					...
					: (this._observer = new ResizeObserver((t) => {
							...
							for (let s of t)
								_e.entries.set(s.target, s),
									(l = this._listeners.get(s.target)) === null ||
										l === void 0 ||
										l(s);
						}));
			}
	...
	function Pt() {
		...
		do {
			...
			for (fe(null), te.length = 0, ee = 0; le.length; ) le.pop()();
	...
	function Bt(n, e, t, l, s, r, i, o, a, h, _, f) {
		...
		for (u = E; u--; ) {
			let M = f(s, r, u),
				L = t(M),
				U = i.get(L);
			U ? l && k.push(() => U.p(M, e)) : ((U = h(L, M)), U.c()),
				T.set(L, (d[u] = U)),
		...
		let F = new Set(),
			x = new Set();
		function ae(M) {
			D(M, 1), M.m(o, _), i.set(M.key, M), (_ = M.first), E--;
		}
		for (; c && E; ) {
			let M = d[E - 1],
				L = n[c - 1],
	...
	function el(n, e) {
		n.$$.dirty[0] === -1 && (te.push(n), Zn(), n.$$.dirty.fill(0)),
			...
			((h.ctx = t
				? t(n, e.props || {}, (f, c, ...E) => {
						...
						return (
							h.ctx &&
								s(h.ctx[f], (h.ctx[f] = u)) &&
								(!h.skip_bound && h.bound[f] && h.bound[f](u), _ && el(n, f)),
							c
						);
					})
				: []),
	...
	function Ve(n, e = {}) {
		...
		if (nl.call(et, s)) {
			...
			return (e.normalize === void 0 || e.normalize === null || e.normalize) &&
				typeof o == 'string'
				? Ve(o)
				: ((t[Vt.includes(s) ? 'regular' : 'irregular'] = l), t);
		}
		for (; z(s.charCodeAt(r)) && r < 9; ) r++;
		if (r > 1 && r < 9) {
			if (((t.language = l.slice(0, r)), r < 4)) {
				let o = 0;
				for (
					;
					s.charCodeAt(r) === 45 &&
					...
					t.extendedLanguageSubtags.push(l.slice(r + 1, r + 4)), (r += 4), o++;
				}
			}
			for (
				s.charCodeAt(r) === 45 &&
					...
					z(s.charCodeAt(r + 4)) &&
					!z(s.charCodeAt(r + 5)) &&
					((t.script = l.slice(r + 1, r + 5)), (r += 5)),
					s.charCodeAt(r) === 45 &&
						(z(s.charCodeAt(r + 1)) &&
						z(s.charCodeAt(r + 2)) &&
						!z(s.charCodeAt(r + 3))
							? ((t.region = l.slice(r + 1, r + 3)), (r += 3))
							: Q(s.charCodeAt(r + 1)) &&
								Q(s.charCodeAt(r + 2)) &&
								Q(s.charCodeAt(r + 3)) &&
								!Q(s.charCodeAt(r + 4)) &&
								((t.region = l.slice(r + 1, r + 4)), (r += 4)));
				s.charCodeAt(r) === 45;
			) {
				let o = r + 1,
					a = o;
				...
				if (a - o > 4 || (a - o > 3 && Q(s.charCodeAt(o))))
					t.variants.push(l.slice(o, a)), (r = a);
				else break;
			}
			for (
				;
		...
		if (
			(r === 0 && s.charCodeAt(r) === 120) ||
			(s.charCodeAt(r) === 45 && s.charCodeAt(r + 1) === 120)
		) {
			r = r ? r + 2 : 1;
			let o = r;
			for (; s.charCodeAt(o) === 45 && K(s.charCodeAt(o + 1)); ) {
				...
				t.privateuse.push(l.slice(r + 1, o)), (r = o);
			}
		}
		if (r !== l.length) return i(r, 6, 'Found superfluous content after tag');
		return t;
		function i(o, a, h) {
			return e.warning && e.warning(h, a, o), e.forgiving ? t : Wt();
		}
	}
	function Wt() {
		return {
	...
	function ll(n) {
		...
		return {
			...
			m(o, a) {
				i && i.m(o, a), y(o, e, a), y(o, t, a), b(t, l), b(t, s), b(t, r);
			},
			p(o, a) {
				o[0]
					? i || ((i = Kt(o)), i.c(), i.m(e.parentNode, e))
					: i && (i.d(1), (i = null));
			},
			d(o) {
				i && i.d(o), o && v(e), o && v(t);
			...
			p(u, m) {
				u[0]
					...
					u[2].length
						? E
							? E.p(u, m)
							: ((E = Zt(u)), E.c(), E.m(t, null))
						: E && (E.d(1), (E = null));
			},
			d(u) {
				c && c.d(u), u && v(e), u && v(t), E && E.d();
			},
		};
	}
	function Kt(n) {
	...
	function Yt(n) {
		...
		return {
			...
			m(l, s) {
				y(l, e, s), t && t.m(e, null);
			},
			p(l, s) {
				l[1].meta.image
					? t
						? t.p(l, s)
						: ((t = Xt(l)), t.c(), t.m(e, null))
					: t && (t.d(1), (t = null));
			},
			d(l) {
				l && v(e), t && t.d();
		...
		return {
			...
			p(s, r) {
				r & 2 && !se(e.src, (t = s[1].meta?.image)) && p(e, 'src', t),
					r & 2 &&
						l !== (l = s[1].meta?.image_alt || s[1].meta?.title) &&
						p(e, 'alt', l);
			},
			d(s) {
				s && v(e);
	...
	function Zt(n) {
		let e,
			t = n[2],
			l = [];
		for (let s = 0; s < t.length; s += 1) l[s] = Qt(Jt(n, t, s));
		return {
			c() {
				e = C('ul');
			...
			p(s, r) {
				if (r & 4) {
					...
					for (i = 0; i < t.length; i += 1) {
						let o = Jt(s, t, i);
						l[i] ? l[i].p(o, r) : ((l[i] = Qt(o)), l[i].c(), l[i].m(e, null));
					}
	...
	function Qt(n) {
		...
		return {
			...
			m(a, h) {
				y(a, e, h), b(e, l), b(e, s), b(e, i), b(e, o);
			},
			p(a, h) {
	...
	function rl(n) {
		...
		return {
			c() {
				(e = C('li')), s.c(), p(e, 'class', 'pagefind-ui__result svelte-j9e30');
			},
			m(r, i) {
				y(r, e, i), s.m(e, null);
			},
	...
	function en(n, e, t) {
		let l = n.slice();
		return (l[11] = e[t][0]), (l[12] = e[t][1]), l;
	}
	function tn(n, e, t) {
		let l = n.slice();
		return (l[15] = e[t]), l;
	...
	function ol(n) {
		...
		return {
			...
			p(o, a) {
				o[0]
					? i || ((i = nn(o)), i.c(), i.m(e.parentNode, e))
					: i && (i.d(1), (i = null));
			},
			d(o) {
				i && i.d(o), o && v(e), o && v(t);
	...
	function al(n) {
		let e,
			...
			E = n[3],
			u = [];
		for (let d = 0; d < E.length; d += 1) u[d] = on(tn(n, E, d));
		...
		return {
			...
			m(d, T) {
				f && f.m(d, T),
					...
					c && c.m(t, null),
					b(t, h);
				for (let R = 0; R < u.length; R += 1) u[R] && u[R].m(t, null);
				b(t, _), m && m.m(t, null);
			},
			p(d, T) {
				if (
					...
					for (R = 0; R < E.length; R += 1) {
						let k = tn(d, E, R);
						u[R] ? u[R].p(k, T) : ((u[R] = on(k)), u[R].c(), u[R].m(t, _));
					}
				...
				d[2].length
					? m
						? m.p(d, T)
						: ((m = an(d)), m.c(), m.m(t, null))
					: m && (m.d(1), (m = null));
			},
			d(d) {
				f && f.d(d), d && v(e), d && v(t), c && c.d(), X(u, d), m && m.d();
			},
		};
	}
	function nn(n) {
	...
	function an(n) {
		let e,
			t = n[2],
			l = [];
		for (let s = 0; s < t.length; s += 1) l[s] = un(en(n, t, s));
		return {
			c() {
				e = C('ul');
				for (let s = 0; s < l.length; s += 1) l[s].c();
			...
			p(s, r) {
				if (r & 4) {
					...
					for (i = 0; i < t.length; i += 1) {
						let o = en(s, t, i);
						l[i] ? l[i].p(o, r) : ((l[i] = un(o)), l[i].c(), l[i].m(e, null));
					}
					for (; i < l.length; i += 1) l[i].d(1);
					l.length = t.length;
				}
		...
		let { show_images: l = !0 } = e,
			...
			c = async (u) => {
				t(1, (o = await u.data())),
					...
					Array.isArray(o.sub_results) &&
						(t(4, (_ = o.sub_results?.[0]?.url === (o.meta?.url || o.url))),
						_
							? t(3, (h = f(o.sub_results.slice(1), 3)))
							: t(3, (h = f([...o.sub_results], 3))));
			},
	...
	function _n(n, e, t) {
		let l = n.slice();
		return (l[9] = e[t][0]), (l[10] = e[t][1]), (l[11] = e), (l[12] = t), l;
	}
	function dn(n, e, t) {
		let l = n.slice();
		return (l[13] = e[t][0]), (l[14] = e[t][1]), (l[15] = e), (l[16] = t), l;
	}
	function hn(n) {
		let e,
			t,
			l = n[3]('filters_label', n[4], n[5]) + '',
			s,
			r,
			i = Object.entries(n[1]),
			o = [];
		for (let a = 0; a < i.length; a += 1) o[a] = gn(_n(n, i, a));
		return {
			c() {
				(e = C('fieldset')), (t = C('legend')), (s = w(l)), (r = S());
			...
			m(a, h) {
				y(a, e, h), b(e, t), b(t, s), b(e, r);
				for (let _ = 0; _ < o.length; _ += 1) o[_] && o[_].m(e, null);
			},
			p(a, h) {
				if (
					(h & 56 &&
						l !== (l = a[3]('filters_label', a[4], a[5]) + '') &&
						N(s, l),
					h & 71)
				) {
					...
					for (_ = 0; _ < i.length; _ += 1) {
						let f = _n(a, i, _);
						o[_] ? o[_].p(f, h) : ((o[_] = gn(f)), o[_].c(), o[_].m(e, null));
					}
	...
	function gn(n) {
		let e,
			...
			f = [];
		for (let c = 0; c < _.length; c += 1) f[c] = pn(dn(n, _, c));
		return {
			c() {
				(e = C('details')),
					(t = C('summary')),
			...
			m(c, E) {
				y(c, e, E),
					...
					(i.innerHTML = o),
					b(r, a);
				for (let u = 0; u < f.length; u += 1) f[u] && f[u].m(r, null);
				b(e, h);
			},
			p(c, E) {
				if (
					(E & 2 &&
						l !== (l = c[9].replace(/^(\w)/, En) + '') &&
						(t.innerHTML = l),
					...
					for (u = 0; u < _.length; u += 1) {
						let m = dn(c, _, u);
						f[u] ? f[u].p(m, E) : ((f[u] = pn(m)), f[u].c(), f[u].m(r, null));
					}
	...
	var dl = 'Jan Claasen',
		...
		gl = { thanks_to: dl, comments: hl, direction: ml, strings: pl };
	var rt = {};
	A(rt, {
		comments: () => bl,
		default: () => Cl,
	...
	var El = 'Pablo Villaverde <https://github.com/pvillaverde>',
		...
		Cl = { thanks_to: El, comments: bl, direction: Rl, strings: Tl };
	var it = {};
	A(it, {
		comments: () => yl,
		default: () => wl,
	...
	var vl = 'Jan Claasen',
		...
		wl = { thanks_to: vl, comments: yl, direction: kl, strings: Sl };
	var ot = {};
	A(ot, {
		comments: () => Ml,
		default: () => Nl,
	...
	var Al = 'Liam Bigelow <liam@cloudcannon.com>',
		...
		Nl = { thanks_to: Al, comments: Ml, direction: Fl, strings: Hl };
	var at = {};
	A(at, {
		comments: () => jl,
		default: () => Ul,
	...
	var Ol = 'Pablo Villaverde <https://github.com/pvillaverde>',
		...
		Ul = { thanks_to: Ol, comments: jl, direction: Dl, strings: zl };
	var ut = {};
	A(ut, {
		comments: () => Ll,
		default: () => Bl,
	...
	var Il = 'Valtteri Laitinen <dev@valtlai.fi>',
		...
		Bl = { thanks_to: Il, comments: Ll, direction: Pl, strings: ql };
	var ct = {};
	A(ct, {
		comments: () => Vl,
		default: () => Kl,
	...
	var Gl = 'Nicolas Friedli <nicolas@theologique.ch>',
		...
		Kl = { thanks_to: Gl, comments: Vl, direction: Wl, strings: Jl };
	var ft = {};
	A(ft, {
		comments: () => Xl,
		default: () => xl,
	...
	var Yl = 'Pablo Villaverde <https://github.com/pvillaverde>',
		...
		xl = { thanks_to: Yl, comments: Xl, direction: Zl, strings: Ql };
	var _t = {};
	A(_t, {
		comments: () => es,
		default: () => ls,
	...
	var $l = 'Amit Yadav <amit@thetechbasket.com>',
		...
		ls = { thanks_to: $l, comments: es, direction: ts, strings: ns };
	var dt = {};
	A(dt, {
		comments: () => rs,
		default: () => as,
	...
	var ss = 'Nixentric',
		...
		as = { thanks_to: ss, comments: rs, direction: is, strings: os };
	var ht = {};
	A(ht, {
		comments: () => cs,
		default: () => ds,
	...
	var us = 'Cosette Bruhns Alonso, Andrew Janco <apjanco@upenn.edu>',
		...
		ds = { thanks_to: us, comments: cs, direction: fs, strings: _s };
	var mt = {};
	A(mt, {
		comments: () => ms,
		default: () => Es,
	...
	var hs = 'Tate',
		...
		Es = { thanks_to: hs, comments: ms, direction: ps, strings: gs };
	var pt = {};
	A(pt, {
		comments: () => Rs,
		default: () => vs,
	...
	var bs = 'Paul van Brouwershaven',
		...
		vs = { thanks_to: bs, comments: Rs, direction: Ts, strings: Cs };
	var gt = {};
	A(gt, {
		comments: () => ks,
		default: () => As,
	...
	var ys = 'Christopher Wingate',
		...
		As = { thanks_to: ys, comments: ks, direction: Ss, strings: ws };
	var Et = {};
	A(Et, {
		comments: () => Fs,
		default: () => Os,
	...
	var Ms = 'Jonatah',
		...
		Os = { thanks_to: Ms, comments: Fs, direction: Hs, strings: Ns };
	var bt = {};
	A(bt, {
		comments: () => Ds,
		default: () => Is,
	...
	var js = 'Aleksandr Gordeev',
		...
		Is = { thanks_to: js, comments: Ds, direction: zs, strings: Us };
	var Rt = {};
	A(Rt, {
		comments: () => Ps,
		default: () => Gs,
	...
	var Ls = 'Andrija Sagicc',
		...
		Gs = { thanks_to: Ls, comments: Ps, direction: qs, strings: Bs };
	var Tt = {};
	A(Tt, {
		comments: () => Ws,
		default: () => Ys,
	...
	var Vs = 'Montazar Al-Jaber <montazar@nanawee.tech>',
		...
		Ys = { thanks_to: Vs, comments: Ws, direction: Js, strings: Ks };
	var Ct = {};
	A(Ct, {
		comments: () => Zs,
		default: () => $s,
	...
	var er = 'Taylan \xD6zg\xFCr Bildik',
		...
		sr = { thanks_to: er, comments: tr, direction: nr, strings: lr };
	var yt = {};
	A(yt, {
		comments: () => ir,
		default: () => ur,
	...
	var rr = 'Amber Song',
		...
		ur = { thanks_to: rr, comments: ir, direction: or, strings: ar };
	var kt = {};
	A(kt, {
		comments: () => fr,
		default: () => hr,
	...
	var cr = 'Amber Song',
		...
		hr = { thanks_to: cr, comments: fr, direction: _r, strings: dr };
	var St = {};
	A(St, {
		comments: () => pr,
		default: () => br,
	...
	function vn(n) {
		...
		return (
			n[7] !== void 0 && (r.selected_filters = n[7]),
			(e = new bn({ props: r })),
			le.push(() => Gt(e, 'selected_filters', s)),
			{
				...
				p(i, o) {
					...
					o[0] & 16 && (a.show_empty_filters = i[4]),
						...
						!t &&
							o[0] & 128 &&
							((t = !0), (a.selected_filters = i[7]), Lt(() => (t = !1))),
						e.$set(a);
				},
				i(i) {
	...
	function Cr(n) {
		...
		return {
			...
			m(m, d) {
				y(m, e, d), f.m(e, null), y(m, t, d), y(m, l, d);
				for (let T = 0; T < s.length; T += 1) s[T] && s[T].m(l, null);
				y(m, i, d), u && u.m(m, d), y(m, o, d), (a = !0);
			},
			p(m, d) {
				_ === (_ = h(m, d)) && f
					? f.p(m, d)
					...
					m[11].results.length > m[15]
						? u
							? u.p(m, d)
							: ((u = Sn(m)), u.c(), u.m(o.parentNode, o))
						: u && (u.d(1), (u = null));
			},
			i(m) {
				if (!a) {
					for (let d = 0; d < c.length; d += 1) D(s[d]);
					a = !0;
				}
			},
			o(m) {
				for (let d = 0; d < s.length; d += 1) I(s[d]);
				a = !1;
			},
			d(m) {
				m && v(e), f.d(), m && v(t), m && v(l);
					...
					e !==
						(e =
							l[18]('many_results', l[17], l[5])
								...
								.replace(
									/\[COUNT\]/,
									new Intl.NumberFormat(l[5].language).format(
										l[11].results.length,
									),
								) + '') &&
					N(t, e);
					...
					e !==
						(e =
							l[18]('one_result', l[17], l[5])
								...
								.replace(
									/\[COUNT\]/,
									new Intl.NumberFormat(l[5].language).format(1),
								) + '') &&
					N(t, e);
			},
			d(l) {
		...
		return {
			...
			p(l, s) {
				s[0] & 147488 &&
					e !==
						(e =
							l[18]('zero_results', l[17], l[5]).replace(
								/\[SEARCH_TERM\]/,
								l[14],
							) + '') &&
					N(t, e);
	...
	function wr(n) {
		...
		return (
			(e = new $t({
				props: { show_images: n[1], process_result: n[3], result: n[47] },
			})),
			{
				c() {
					Ge(e.$$.fragment);
	...
	function kn(n, e) {
		...
		return (
			...
			(s = a[l] = o[l](e)),
			{
				...
				first: null,
				c() {
					(t = Z()), s.c(), (r = Z()), (this.first = t);
				},
				m(_, f) {
					y(_, t, f), a[l].m(_, f), y(_, r, f), (i = !0);
				},
				p(_, f) {
					e = _;
					let c = l;
	...
	function Sn(n) {
		...
		return {
			...
			m(i, o) {
				y(i, e, o), b(e, l), s || ((r = W(e, 'click', n[20])), (s = !0));
			},
			p(i, o) {
				o[0] & 131104 &&
		...
		return {
			...
			p(s, r) {
				r[0] & 147488 &&
					t !==
						(t =
							s[18]('searching', s[17], s[5]).replace(
								/\[SEARCH_TERM\]/,
								s[14],
							) + '') &&
					N(l, t);
	...
	function Mr(n) {
		...
		return {
			...
			p(R, k) {
				(!E ||
					(k[0] & 131104 && s !== (s = R[18]('placeholder', R[17], R[5])))) &&
					p(l, 'placeholder', s),
					k[0] & 64 && l.value !== R[6] && xe(l, R[6]),
					(!E || k[0] & 131104) &&
						o !== (o = R[18]('clear_search', R[17], R[5]) + '') &&
						N(a, o),
					(!E || k[0] & 64) && B(i, 'pagefind-ui__suppressed', !R[6]),
					R[10]
						? d
							? (d.p(R, k), k[0] & 1024 && D(d, 1))
							: ((d = vn(R)), d.c(), D(d, 1), d.m(_, f))
						: d &&
							(re(),
							I(d, 1, 1, () => {
								d = null;
					...
					R[13]
						? T
							? (T.p(R, k), k[0] & 8192 && D(T, 1))
							: ((T = yn(R)), T.c(), D(T, 1), T.m(_, null))
						: T &&
							(re(),
							I(T, 1, 1, () => {
								T = null;
					...
					(!E ||
						(k[0] & 131104 &&
							c !== (c = R[18]('search_label', R[17], R[5])))) &&
						p(t, 'aria-label', c),
	...
	function Hr(n, e, t) {
		...
		for (let g = 0; g < s.length; g++)
			l[s[g]] = { language: s[g], ...Rn[g].strings };
		let { base_path: r = '/pagefind/' } = e,
			{ reset_styles: i = !0 } = e,
			{ show_images: o = !0 } = e,
			{ show_sub_results: a = !1 } = e,
			{ excerpt_length: h } = e,
			{ process_result: _ = null } = e,
			{ process_term: f = null } = e,
			{ show_empty_filters: c = !0 } = e,
			{ debounce_timeout_ms: E = 300 } = e,
			{ pagefind_options: u = {} } = e,
			{ merge_index: m = [] } = e,
			{ trigger_search_term: d = '' } = e,
			{ translations: T = {} } = e,
			R = '',
			k,
			F,
		...
		$e(() => {
			...
			t(
				17,
				(Nt =
					l[`${H.language}-${H.script}-${H.region}`] ||
					l[`${H.language}-${H.region}`] ||
					l[`${H.language}`] ||
					l.en),
			);
		});
...
`),
					...
					h || t(22, (h = a ? 12 : 30));
					let H = { ...(u || {}), excerptLength: h };
					await g.options(H);
					for (let O of m) {
						if (!O.bundlePath)
							throw new Error('mergeIndex requires a bundlePath parameter');
						let P = O.bundlePath;
						delete O.bundlePath, await g.mergeIndex(P, O);
					}
					(k = g), Fn();
				}
			},
			...
			Nn = async (g, H) => {
				...
				E > 0 && g
					? (ce && clearTimeout(ce),
						(ce = setTimeout(P, E)),
						await jt(),
						k.preload(g, { filters: O }))
					: P(),
					jn();
			},
			jt = async () => {
				for (; !k; ) Ot(), await new Promise((g) => setTimeout(g, 50));
			},
			On = async (g, H) => {
				t(14, (Ft = g || '')),
					...
					await jt();
				let O = ++Mt,
					P = await k.search(g, { filters: H });
				Mt === O &&
					(P.filters &&
						Object.keys(P.filters)?.length &&
						t(16, (ue = P.filters)),
					t(11, (L = P)),
					t(12, (U = !1)),
					t(15, (Je = 5)));
			...
			Dn = (g) => {
				g?.preventDefault(), t(15, (Je += 5));
			},
			zn = (g) => {
				g.key === 'Escape' && (t(6, (R = '')), F.blur()),
					g.key === 'Enter' && g.preventDefault();
			};
		function Un() {
			(R = this.value), t(6, R), t(21, d);
		}
		function In(g) {
			le[g ? 'unshift' : 'push'](() => {
				(F = g), t(8, F);
		...
		return (
			...
			(n.$$.update = () => {
				if (n.$$.dirty[0] & 2097152) e: d && (t(6, (R = d)), t(21, (d = '')));
				if (n.$$.dirty[0] & 192) e: Nn(R, Ie);
			}),
			[
				i,
				o,
	...
	var At;
	try {
		At = new URL(document.currentScript.src).pathname.match(
			/^(.*\/)(?:pagefind-)?ui.js.*$/,
		)[1];
	} catch {
		At = '/pagefind/';
