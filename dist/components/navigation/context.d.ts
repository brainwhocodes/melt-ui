...
export interface NavigationMenuRootContext {
    ...
    registerTrigger: (value: string, element: HTMLButtonElement, disabled: () => boolean) => () => void;
...
export declare const NAVIGATION_MENU_ROOT: {};
export declare const NAVIGATION_MENU_ITEM: {};
export interface SidebarContext {
    collapsed: Writable<boolean>;
    open: Writable<boolean>;
    toggle: () => void;
}
export declare const SIDEBAR_ROOT: {};
