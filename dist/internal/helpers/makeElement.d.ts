...
export declare const emptyMeltElement: MeltElement<Stores | undefined, Action<any, any, Record<never, any>>, (() => Record<string, any> | ((...args: any[]) => Record<string, any>)) | ((values: unknown) => Record<string, any> | ((...args: any[]) => Record<string, any>)) | ((values: unknown[]) => Record<string, any> | ((...args: any[]) => Record<string, any>)) | ((values: [unknown, ...unknown[]]) => Record<string, any> | ((...args: any[]) => Record<string, any>)), "empty">;
