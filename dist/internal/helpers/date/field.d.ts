 ...
 */
export declare function handleSegmentNavigation(e: KeyboardEvent, fieldId: string, rootElement?: ParentNode): void;
/**
 ...
 * @param fieldId - The ID of the field we're navigating within
 */
export declare function getPrevNextSegments(node: HTMLElement, fieldId: string, rootElement?: ParentNode): {
 ...
 */
export declare function moveToNextSegment(e: KeyboardEvent, fieldId: string, rootElement?: ParentNode): void;
 ...
 */
export declare function getSegments(id: string, rootElement?: ParentNode): HTMLElement[];
/**
 * Get the first interactive segment within the field identified by the provided ID.
 */
export declare function getFirstSegment(id: string, rootElement?: ParentNode): HTMLElement;
