...
import { getElementById, isHTMLElement, kbd, } from '../index.js';
/**
 ...
 */
export function handleSegmentNavigation(e, fieldId, rootElement) {
 ...
 * @param fieldId - The ID of the field we're navigating within
 */
export function getPrevNextSegments(node, fieldId, rootElement) {
 ...
 */
export function moveToNextSegment(e, fieldId, rootElement) {
 ...
 */
export function getSegments(id, rootElement) {
 ...
 */
export function getFirstSegment(id, rootElement) {
