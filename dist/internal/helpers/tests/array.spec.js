...
describe('back', () => {
    ...
    ])('back($array, $index, $increment, $loop) -> $expected', ({ array, index, increment, loop, expected }) => {
...
describe('forward', () => {
    ...
    ])('forward($array, $index, $increment, $loop) -> $expected', ({ array, index, increment, loop, expected }) => {
