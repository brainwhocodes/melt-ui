...
import { getDirectionalKeys, getNextKey, getPrevKey, kbd, } from '../keyboard.js';
describe('getNextKey', () => {
    test.each([
    ...
    ])('getNextKey($dir, $orientation) -> $expected', ({ dir, orientation, expected }) => {
...
describe('getPrevKey', () => {
    ...
    ])('getPrevKey($dir, $orientation) -> $expected', ({ dir, orientation, expected }) => {
...
describe('getDirectionalKeys', () => {
    ...
    ])('getDirectionalKeys($dir, $orientation) -> $expected', ({ dir, orientation, expected }) => {
