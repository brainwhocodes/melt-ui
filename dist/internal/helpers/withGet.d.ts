...
export declare namespace withGet {
    ...
    var derived: <S extends WithGet<Readable<unknown>> | [WithGet<Readable<unknown>>, ...Array<WithGet<Readable<unknown>>>] | Array<WithGet<Readable<unknown>>>, T>(stores: S, fn: (values: StoresValues<S>) => T) => WithGet<Readable<T>>;
}
