...
import type { CreateCalendarProps, CreatePopoverProps } from '../index.js';
...
type ModifiedDateFieldProps = Omit<RenameProperties<CreateDateFieldProps, {
    ids: 'dateFieldIds';
}>, 'readonlySegments'>;
type ModifiedCalendarProps = RenameProperties<CreateCalendarProps, {
    ids: 'calendarIds';
}>;
type ModifiedPopoverProps = Omit<RenameProperties<CreatePopoverProps, {
    ids: 'popoverIds';
}>, 'disabled'>;
export type CreateDatePickerProps = Expand<DatePickerProps & ModifiedDateFieldProps & ModifiedPopoverProps & ModifiedCalendarProps>;
