...
export declare const createAccordion: <Multiple extends boolean = false>(props?: CreateAccordionProps<Multiple>) => {
    ids: {
        [x: string]: string;
    };
    elements: {
        ...
        heading: import("../../internal/helpers/index.js").MeltElement<import("../../internal/helpers/store/types.js").Stores | undefined, import("svelte/action").Action<any, any, Record<never, any>>, () => (props: AccordionHeadingProps) => {
    ...
    states: {
        value: NonNullable<CreateAccordionProps<Multiple>["value"]>;
    };
    helpers: {
