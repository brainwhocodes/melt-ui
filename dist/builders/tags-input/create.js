...
import { addMeltEventListener, createElHelpers, disabledAttr, effect, executeCallbacks, generateId, getElementByMeltId, isBrowser, isHTMLElement, kbd, makeElement, noop, omit, overridable, styleToString, toWritableStores, } from '../../internal/helpers/index.js';
    ...
    const tagsWritable = withDefaults.tags ??
        writable(withDefaults.defaultTags && withDefaults.defaultTags.length > 0
            ? typeof withDefaults.defaultTags[0] === 'string'
                ? withDefaults.defaultTags.map((tag) => ({
                    id: generateId(),
                    value: tag,
                }))
