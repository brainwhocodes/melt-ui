...
export declare function createTreeView(args?: CreateTreeViewProps): {
    ...
    elements: {
        tree: import("../../internal/helpers/index.js").MeltElement<import("../../internal/helpers/store/types.js").Stores | undefined, import("svelte/action").Action<any, any, Record<never, any>>, () => {
            readonly role: "tree";
