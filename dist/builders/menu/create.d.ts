...
export declare function createMenuBuilder(opts: _MenuBuilderOptions): {
    elements: {
        ...
        item: import("../../internal/helpers/index.js").MeltElement<import("../../internal/helpers/store/types.js").Stores | undefined, (node: HTMLElement) => MeltActionReturn<MenuEvents["item"]>, () => {
    ...
    builders: {
        ...
        createSubmenu: (args?: _CreateSubmenuProps) => {
            ...
            options: import("../../internal/helpers/index.js").ToWritableStores<Omit<{
                ...
                ids?: Partial<import("../../internal/helpers/index.js").IdObj<_MenuIdParts>>;
