...
import type { CreateDateFieldProps, DateFieldIdParts, DateRange, Matcher } from '../../index.js';
import type { ChangeFn, IdObj } from '../../internal/helpers/index.js';
import type { EditableSegmentPart } from '../../shared/index.js';
...
export type CreateDateRangeFieldProps = Expand<DateRangeFieldProps & Omit<CreateDateFieldProps, 'value' | 'defaultValue' | 'onValueChange' | 'ids' | 'name' | 'readonlySegments'>>;
