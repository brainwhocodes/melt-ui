...
export declare function createDialog(props?: CreateDialogProps): {
    ...
    elements: {
        ...
        close: import("../../internal/helpers/index.js").MeltElement<import("../../internal/helpers/store/types.js").Stores | undefined, (node: HTMLElement) => MeltActionReturn<DialogEvents["close"]>, () => {
            readonly type: "button";
        }, string>;
        portalled: import("../../internal/helpers/index.js").MeltElement<import("../../internal/helpers/withGet.js").WithGet<import("svelte/store").Writable<string | HTMLElement | null>>, (node: HTMLElement) => {
            destroy(): void;
    ...
    options: import("../../internal/helpers/index.js").ToWritableStores<Omit<{
        ...
        ids?: Partial<import("../../internal/helpers/index.js").IdObj<DialogIdParts>>;
    }, "ids">>;
};
