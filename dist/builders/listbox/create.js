...
import { addHighlight, addMeltEventListener, back, createClickOutsideIgnore, createElHelpers, createTypeaheadSearch, derivedVisible, disabledAttr, effect, executeCallbacks, FIRST_LAST_KEYS, forward, generateId, getElementById, getOptions, getPortalDestination, isBrowser, isElement, isElementDisabled, isHTMLButtonElement, isHTMLElement, isHTMLInputElement, isObject, kbd, last, makeElement, next, noop, omit, overridable, prev, removeHighlight, removeScroll, stripValues, styleToString, toggle, toWritableStores, withGet, } from '../../internal/helpers/index.js';
                ...
                if ((e.key === kbd.ENTER && !e.isComposing) ||
                    ...
                    if ($highlightedItem) {
                        ...
                        const enabledItems = isHTMLElement(menuElement)
                            ? getOptions(menuElement).filter((item) => !isElementDisabled(item) &&
