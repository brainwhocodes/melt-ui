...
export declare function createListbox<Value, Multiple extends boolean = false, S extends ListboxSelected<Multiple, Value> = ListboxSelected<Multiple, Value>>(props?: CreateListboxProps<Value, Multiple, S>): {
    ...
    elements: {
        ...
        label: import("../../internal/helpers/index.js").MeltElement<[import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<string>>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<string>>], (node: HTMLElement) => MeltActionReturn<import("../label/events.js").LabelEvents["root"]>, ([$labelId, $triggerId]: [string, string]) => {
            readonly id: string;
            readonly for: string;
        }, string>;
        hiddenInput: import("../../internal/helpers/index.js").MeltElement<[import("../../internal/helpers/index.js").WithGet<Readable<string>>, Readable<string | undefined>, import("../../internal/helpers/index.js").WithGet<Readable<boolean>>, import("../../internal/helpers/index.js").WithGet<Readable<boolean>>, import("../../internal/helpers/index.js").WithGet<Readable<import("svelte/elements").HTMLInputTypeAttribute | null | undefined>>, import("../../internal/helpers/index.js").WithGet<Readable<boolean | undefined>>], (node: HTMLInputElement) => {
            destroy: () => void;
    ...
    states: {
        ...
        selected: {
            ...
            subscribe(this: void, run: import("svelte/store").Subscriber<S | undefined>, invalidate?: () => void): import("svelte/store").Unsubscriber;
            get: () => S | undefined;
            destroy?: () => void;
        };
