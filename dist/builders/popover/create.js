...
import { addMeltEventListener, createElHelpers, derivedVisible, effect, executeCallbacks, generateIds, getPortalDestination, handleFocus, isBrowser, isElement, kbd, makeElement, noop, omit, overridable, portalAttr, removeScroll, styleToString, toWritableStores, withGet, } from '../../internal/helpers/index.js';
const defaults = {
    positioning: {
        placement: 'bottom',
    },
