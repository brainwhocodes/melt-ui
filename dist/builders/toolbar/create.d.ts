...
export declare const createToolbar: (props?: CreateToolbarProps) => {
    elements: {
        ...
        button: import("../../internal/helpers/index.js").MeltElement<import("../../internal/helpers/store/types.js").Stores | undefined, (node: HTMLElement) => MeltActionReturn<ToolbarEvents["button"]>, () => {
        ...
        link: import("../../internal/helpers/index.js").MeltElement<import("../../internal/helpers/store/types.js").Stores | undefined, (node: HTMLElement) => MeltActionReturn<ToolbarEvents["link"]>, () => {
            readonly role: "link";
        }, string>;
    };
    builders: {
        createToolbarGroup: <T extends ToolbarGroupType = "single">(props?: CreateToolbarGroupProps<T>) => {
            elements: {
                ...
                item: import("../../internal/helpers/index.js").MeltElement<[import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<boolean>>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<"single" | T>>, {
                    ...
                    subscribe(this: void, run: import("svelte/store").Subscriber<string | string[] | undefined>, invalidate?: () => void): import("svelte/store").Unsubscriber;
            ...
            options: import("../../internal/helpers/index.js").ToWritableStores<{
                ...
                onValueChange?: import("../../internal/helpers/index.js").ChangeFn<string | string[] | undefined>;
                type: "single" | T;
                disabled: boolean;
            }>;
        };
