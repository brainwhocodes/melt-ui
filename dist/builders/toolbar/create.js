...
import { addMeltEventListener, createElHelpers, disabledAttr, executeCallbacks, handleRovingFocus, isHTMLElement, kbd, makeElement, overridable, toWritableStores, } from '../../internal/helpers/index.js';
const defaults = {
    loop: true,
    ...
    const createToolbarGroup = (props) => {
        ...
        const defaultValue = groupWithDefaults.defaultValue
            ...
            : groupWithDefaults.type === 'single'
                ? undefined
                : [];
        const valueWritable = groupWithDefaults.value ??
