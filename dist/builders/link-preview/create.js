...
import { addMeltEventListener, createElHelpers, derivedVisible, effect, executeCallbacks, getPortalDestination, getTabbableNodes, isBrowser, isElement, isFocusVisible, isHTMLElement, isTouch, makeElement, noop, overridable, portalAttr, sleep, styleToString, toWritableStores, } from '../../internal/helpers/index.js';
...
export function createLinkPreview(props = {}) {
    ...
    const { openDelay, closeDelay, positioning, arrowSize, closeOnOutsideClick, forceVisible, portal, escapeBehavior, onOutsideClick, preventTextSelectionOverflow, } = options;
