...
export declare function createDateRangePicker(props?: CreateDateRangePickerProps): {
    elements: {
        trigger: import("../../internal/helpers/index.js").MeltElement<[import("../../internal/helpers/index.js").MeltElement<[{
            ...
            get: () => boolean;
            destroy?: () => void;
        }, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<string>>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<string>>], (node: HTMLElement) => MeltActionReturn<import("../popover/events.js").PopoverEvents["trigger"]>, ([$open, $contentId, $triggerId]: [boolean, string, string]) => {
            ...
            action: (node: HTMLElement) => MeltActionReturn<import("../popover/events.js").PopoverEvents["trigger"]>;
        }, boolean]) => {
        ...
        close: import("../../internal/helpers/index.js").MeltElement<import("../../internal/helpers/store/types.js").Stores | undefined, (node: HTMLElement) => MeltActionReturn<import("../popover/events.js").PopoverEvents["close"]>, () => {
        ...
        startSegment: import("../../internal/helpers/index.js").MeltElement<[import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<import("../date-field/_internal/types.js").SegmentValueObj>>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Readable<12 | 24>>, {
            ...
            subscribe: (this: void, run: import("svelte/store").Subscriber<import("@internationalized/date").DateValue>, invalidate?: () => void) => import("svelte/store").Unsubscriber;
            ...
            subscribe(this: void, run: import("svelte/store").Subscriber<import("@internationalized/date").DateValue | undefined>, invalidate?: () => void): import("svelte/store").Unsubscriber;
            ...
            dayPeriod: string;
            timeZoneName: string;
        }>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<ParentNode | undefined>>], (node: HTMLElement) => MeltActionReturn<import("../date-field/events.js").DateFieldEvents["segment"]>, ([$segmentValues, $hourCycle, $placeholder, $value, $isInvalid, $disabled, $readonly, $readonlySegmentsSet, $idValues, $rootElement,]: [import("../date-field/_internal/types.js").SegmentValueObj, 12 | 24, import("@internationalized/date").DateValue, import("@internationalized/date").DateValue | undefined, boolean, boolean, boolean, Set<import("../../index.js").SegmentPart>, {
            field: string;
            label: string;
            description: string;
            validation: string;
        ...
        endSegment: import("../../internal/helpers/index.js").MeltElement<[import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<import("../date-field/_internal/types.js").SegmentValueObj>>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Readable<12 | 24>>, {
            get: () => import("@internationalized/date").DateValue;
            set: (this: void, value: import("@internationalized/date").DateValue) => void;
            update: (this: void, updater: import("svelte/store").Updater<import("@internationalized/date").DateValue>) => void;
            subscribe: (this: void, run: import("svelte/store").Subscriber<import("@internationalized/date").DateValue>, invalidate?: () => void) => import("svelte/store").Unsubscriber;
        ...
        endHiddenInput: import("../../internal/helpers/index.js").MeltElement<[import("../../internal/helpers/index.js").WithGet<import("svelte/store").Readable<string>>, import("svelte/store").Readable<string | undefined>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Readable<boolean>>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Readable<boolean>>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Readable<import("svelte/elements").HTMLInputTypeAttribute | null | undefined>>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Readable<boolean | undefined>>], (node: HTMLInputElement) => {
            destroy: () => void;
        }, ([$value, $name, $disabled, $required, $type, $checked]: [string, string | undefined, boolean, boolean, import("svelte/elements").HTMLInputTypeAttribute | null | undefined, boolean | undefined]) => {
            readonly name: string | undefined;
            readonly value: string;
    ...
    states: {
        ...
        value: {
            ...
            subscribe(this: void, run: import("svelte/store").Subscriber<import("../../internal/helpers/date/index.js").DateRange>, invalidate?: () => void): import("svelte/store").Unsubscriber;
    ...
    options: {
        ...
        rootElement: import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<ParentNode | undefined>>;
