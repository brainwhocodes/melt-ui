...
import type { CreatePopoverProps } from '../index.js';
import type { DateRange, Matcher } from '../../index.js';
import type { ChangeFn } from '../../internal/helpers/index.js';
import type { RenameProperties } from '../../internal/types.js';
...
type ModifiedDateFieldProps = Omit<RenameProperties<CreateDateRangeFieldProps, {
    ids: 'dateFieldIds';
}>, 'readonlySegments'>;
type ModifiedCalendarProps = RenameProperties<CreateRangeCalendarProps, {
    ids: 'calendarIds';
}>;
type ModifiedPopoverProps = Omit<RenameProperties<CreatePopoverProps, {
    ids: 'popoverIds';
}>, 'disabled'>;
export type CreateDateRangePickerProps = Expand<DateRangePickerProps & ModifiedDateFieldProps & ModifiedPopoverProps & ModifiedCalendarProps>;
