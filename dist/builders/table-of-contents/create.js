...
import { addMeltEventListener, createElHelpers, executeCallbacks, makeElement, } from '../../internal/helpers/index.js';
...
export function createTableOfContents(args) {
    ...
    function generateInitialLists(elementTarget) {
        ...
        elementsList = elementsList.filter((el) => includedHeadings.includes(el.nodeName.toLowerCase()) ||
