...
export declare function createSwitch(props?: CreateSwitchProps): {
    elements: {
        root: import("../../internal/helpers/index.js").MeltElement<[{
            ...
            get: () => boolean;
            destroy?: () => void;
        }, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<boolean>>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<boolean>>], (node: HTMLElement) => MeltActionReturn<SwitchEvents["root"]>, ([$checked, $disabled, $required]: [boolean, boolean, boolean]) => {
    ...
    options: import("../../internal/helpers/index.js").ToWritableStores<Omit<{
        ...
        checked?: import("svelte/store").Writable<boolean>;
        onCheckedChange?: import("../../internal/helpers/index.js").ChangeFn<boolean>;
        disabled: boolean;
        required: boolean;
        name: string;
        value: string;
