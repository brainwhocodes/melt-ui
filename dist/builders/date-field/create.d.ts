...
export declare function createDateField(props?: CreateDateFieldProps): {
    elements: {
        ...
        segment: import("../../internal/helpers/index.js").MeltElement<[import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<import("./_internal/types.js").SegmentValueObj>>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Readable<12 | 24>>, {
            get: () => DateValue;
            ...
            dayPeriod: string;
            timeZoneName: string;
        }>, import("../../internal/helpers/index.js").WithGet<import("svelte/store").Writable<ParentNode | undefined>>], (node: HTMLElement) => MeltActionReturn<DateFieldEvents["segment"]>, ([$segmentValues, $hourCycle, $placeholder, $value, $isInvalid, $disabled, $readonly, $readonlySegmentsSet, $idValues, $rootElement,]: [import("./_internal/types.js").SegmentValueObj, 12 | 24, DateValue, DateValue | undefined, boolean, boolean, boolean, Set<SegmentPart>, {
            field: string;
            label: string;
            description: string;
            validation: string;
            ...
            dayPeriod: string;
            timeZoneName: string;
        }, ParentNode | undefined]) => (part: SegmentPart) => {
            readonly 'aria-invalid': "true" | undefined;
            readonly 'aria-disabled': "true" | undefined;
            readonly 'aria-readonly': "true" | undefined;
            readonly 'data-invalid': "" | undefined;
            readonly 'data-disabled': "" | undefined;
            readonly 'data-segment': SegmentPart;
        } | {
            readonly id: string;
            readonly 'aria-labelledby': string;
    ...
    options: import("../../internal/helpers/index.js").ToWritableStores<Omit<{
        ...
        onValueChange?: import("../../internal/helpers/index.js").ChangeFn<DateValue | undefined>;
        value: import("svelte/store").Writable<DateValue | undefined>;
        defaultPlaceholder?: DateValue;
        placeholder?: import("svelte/store").Writable<DateValue>;
        onPlaceholderChange?: import("../../internal/helpers/index.js").ChangeFn<DateValue>;
        isDateUnavailable: import("../../internal/helpers/date/index.js").Matcher;
        minValue: DateValue;
        maxValue: DateValue;
        disabled: boolean;
        readonly: boolean;
        readonlySegments: import("./_internal/types.js").EditableSegmentPart[];
        hourCycle: 12 | 24;
        locale: string;
        granularity: import("../../internal/helpers/date/index.js").Granularity;
        hideTimeZone: boolean;
        name: string;
        required: boolean;
        rootElement: ParentNode;
        ids?: Partial<import("../../internal/helpers/index.js").IdObj<DateFieldIdParts>>;
