...
import type { IdObj } from '../../../internal/helpers/index.js';
import type { DateFieldIdParts } from '../create.js';
import type { DateAndTimeSegmentObj, DateSegmentPart, DayPeriod, EditableSegmentPart, HourCycle, SegmentContentObj, SegmentPart, SegmentStateMap, SegmentValueObj } from './types.js';
...
export declare function initSegmentIds(): IdObj<DateFieldIdParts>;
...
export declare function getValueFromSegments(props: GetValueFromSegments, rootElement?: ParentNode): DateValue;
/**
 ...
 */
export declare function areAllSegmentsFilled(segmentValues: SegmentValueObj, id: string, rootElement?: ParentNode): boolean;
/**
 ...
 */
export declare function isFirstSegment(id: string, fieldId: string, rootElement?: ParentNode): boolean;
/**
 ...
 */
export declare function setDescription(id: string, formatter: Formatter, value: DateValue, rootElement?: ParentNode): void;
/**
