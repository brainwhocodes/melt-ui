...
import { getPlaceholder, getSegments, hasTime, isZonedDateTime, toDate, } from '../../../internal/helpers/date/index.js';
import { generateId, getElementById, isBrowser, isNull, isNumberString, kbd, styleToString, } from '../../../internal/helpers/index.js';
 ...
 * been filled.
 */
function getUsedSegments(id, rootElement) {
    if (!isBrowser)
        return [];
...
export function getValueFromSegments(props, rootElement) {
 ...
 */
export function areAllSegmentsFilled(segmentValues, id, rootElement) {
    const usedSegments = getUsedSegments(id, rootElement);
 ...
 */
export function isFirstSegment(id, fieldId, rootElement) {
    if (!isBrowser)
        return false;
 ...
 */
export function setDescription(id, formatter, value, rootElement) {
    if (!isBrowser)
        return;
    ...
    const ownerDocument = scope.nodeType === Node.DOCUMENT_NODE
        ? scope
    ...
    const container = scope.nodeType === Node.DOCUMENT_NODE
