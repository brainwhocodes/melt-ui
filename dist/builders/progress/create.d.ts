...
export declare const createProgress: (props?: CreateProgressProps) => {
    elements: {
        root: import("../../internal/helpers/index.js").MeltElement<[{
            ...
            subscribe(this: void, run: import("svelte/store").Subscriber<number | null>, invalidate?: () => void): import("svelte/store").Unsubscriber;
            get: () => number | null;
            destroy?: () => void;
            ...
            readonly 'data-state': "indeterminate" | "loading" | "complete";
    ...
    options: import("../../internal/helpers/index.js").ToWritableStores<Omit<{
        ...
        value?: import("svelte/store").Writable<number | null>;
        onValueChange?: import("../../internal/helpers/index.js").ChangeFn<number | null>;
        max: number;
    }, "value">>;
};
