...
export declare function createToaster<T = object>(props?: CreateToasterProps): {
    elements: {
        ...
        close: import("../../internal/helpers/index.js").MeltElement<import("../../internal/helpers/store/types.js").Stores | undefined, (node: HTMLElement) => MeltActionReturn<ToastEvents["close"]>, () => (id: string) => {
    ...
    actions: {
        portal: <Node extends HTMLElement>(el: Node, target?: import("../../internal/actions/index.js").PortalConfig) => {
            destroy: typeof noop;
            update?: undefined;
        } | {
